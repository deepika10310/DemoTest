package com.edu.yati.auth.controller;
...
import com.edu.yati.auth.model.User;
import com.edu.yati.auth.service.UserService;
...
public class UserController {
    ...
    @RequestMapping(value = "/api/admin/username", method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "/api/admin/user/{id}", method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE})
